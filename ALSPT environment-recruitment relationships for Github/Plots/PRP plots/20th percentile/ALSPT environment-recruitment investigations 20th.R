...
setwd(here("Plots","PRP plots/20th percentile"))
library(ggplot2)

##################### Upper first
### first upper annual temp
uppantdiv <- quantile(upper$AnnT, probs = 0.2) # division
...
aa <- ggplot(data=upper, aes(x=AnnT,y=RecDev)) +
  ...
  theme_bw() +
  annotate("text", x=-0.1, y=0.8, label= "Median = -0.20
  SD = 0.51
  Good = 20%
  Poor = 80%",
           col="black", size=3) +
  annotate("text", x=1, y=-0.5, label= "Median = 0.32
  SD = 0.47",
           col="black", size=3)
aa
...
uppansdiv <- quantile(upper$AnnS, probs = 0.2)
...
ca <- ggplot(data=upper, aes(x=AnnS,y=RecDev)) +
  ...
  theme_bw() +
  annotate("text", x=-2, y=0.8, label= "Median = -0.17
  SD = 0.26
  Good = 0%
  Poor = 100%",
           col="black", size=3) +
  annotate("text", x=2, y=-0.5, label= "Median = 0.46
  SD = 0.54",
           col="black", size=3)
ca
...
#########
# seasonal temp
uppjunocttdiv <- quantile(upper$JunOctT, probs = 0.2) # division
...
ba <- ggplot(data=upper, aes(x=JunOctT,y=RecDev)) +
  ...
  theme_bw() +
  annotate("text", x=-0.8, y=0.8, label= "Median = -0.17
  SD = 0.48
  Good = 0%
  Poor = 100%",
           col="black", size=3) +
...
##########################################################
### seasonal sal
uppjunoctsdiv <- quantile(upper$JunOctS, probs = 0.2)
...
da <- ggplot(data=upper, aes(x=JunOctS,y=RecDev)) +
  ...
  theme_bw() +
  annotate("text", x=-3, y=0.8, label= "Median = 0.00
  SD = 0.24
  Good = 0%
  Poor = 100%",
           col="black", size=3) +
...
### first upper annual temp
lowantdiv <- quantile(lower$AnnT, probs = 0.2) # division
...
ab <- ggplot(data=lower, aes(x=AnnT,y=RecDev)) +
  ...
  theme_bw() +
  annotate("text", x=0, y=0.8, label= "Median = 0.46
  SD = 0.57
  Good = 60%
  Poor = 40%",
           col="black", size=3) +
  annotate("text", x=1, y=-0.5, label= "Median = 0.27
  SD = 0.51",
           col="black", size=3)
...
lowansdiv <- quantile(lower$AnnS, probs = 0.2)
...
cb <- ggplot(data=lower, aes(x=AnnS,y=RecDev)) +
  ...
  theme_bw() +
  annotate("text", x=-3, y=0.8, label= "Median = 0.27
  SD = 0.31
  Good = 20%
  Poor = 80%",
           col="black", size=3) +
  annotate("text", x=3, y=-0.5, label= "Median = 0.32
  SD = 0.55",
           col="black", size=3)
...
#########
# seasonal temp
lowjunocttdiv <- quantile(lower$JunOctT, probs = 0.2) # division
...
bb <- ggplot(data=lower, aes(x=JunOctT,y=RecDev)) +
  ...
  theme_bw() +
  annotate("text", x=-0.5, y=0.8, label= "Median = -0.14
  SD = 0.52
  Good = 20%
  Poor = 80%",
           col="black", size=3) +
  annotate("text", x=0.75, y=-0.5, label= "Median = 0.32
  SD = 0.47",
           col="black", size=3)
...
##########################################################
### lower seasonal sal
lowjunoctsdiv <- quantile(lower$JunOctS, probs = 0.2)
...
db <- ggplot(data=lower, aes(x=JunOctS,y=RecDev)) +
  ...
  theme_bw() +
  annotate("text", x=-4, y=0.8, label= "Median = -0.17
  SD = 0.21
  Good = 0%
  Poor = 100%",
           col="black", size=3) +
