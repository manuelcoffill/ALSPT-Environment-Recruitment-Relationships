...
setwd(here("Plots","PRP plots/30th percentile"))
library(ggplot2)

##################### Upper first
### first upper annual temp
uppantdiv <- quantile(upper$AnnT, probs = 0.3) # division
...
aa <- ggplot(data=upper, aes(x=AnnT,y=RecDev)) +
  ...
  theme_bw() +
  annotate("text", x=0, y=0.8, label= "Median = 0.27
  SD = 0.63
  Good = 43%
  Poor = 57%",
           col="black", size=3) +
...
uppansdiv <- quantile(upper$AnnS, probs = 0.3)
...
ca <- ggplot(data=upper, aes(x=AnnS,y=RecDev)) +
  ...
  theme_bw() +
  annotate("text", x=-2, y=0.8, label= "Median = 0.00
  SD = 0.25
  Good = 0%
  Poor = 100%",
           col="black", size=3) +
  annotate("text", x=2, y=-0.5, label= "Median = 0.48
  SD = 0.56",
           col="black", size=3)
ca
...
#########
# seasonal temp
uppjunocttdiv <- quantile(upper$JunOctT, probs = 0.3) # division
...
ba <- ggplot(data=upper, aes(x=JunOctT,y=RecDev)) +
  ...
  theme_bw() +
  annotate("text", x=-0.8, y=0.8, label= "Median = 0.00
  SD = 0.41
  Good = 0%
  Poor = 100%",
           col="black", size=3) +
  annotate("text", x=1, y=-0.5, label= "Median = 0.48
  SD = 0.49",
           col="black", size=3)
...
##########################################################
### seasonal sal
uppjunoctsdiv <- quantile(upper$JunOctS, probs = 0.3)
...
### first upper annual temp
lowantdiv <- quantile(lower$AnnT, probs = 0.3) # division
...
ab <- ggplot(data=lower, aes(x=AnnT,y=RecDev)) +
  ...
  theme_bw() +
  annotate("text", x=0.1, y=0.8, label= "Median = 0.27
  SD = 0.64
  Good = 43%
  Poor = 57%",
           col="black", size=3) +
...
lowansdiv <- quantile(lower$AnnS, probs = 0.3)
...
cb <- ggplot(data=lower, aes(x=AnnS,y=RecDev)) +
  ...
  theme_bw() +
  annotate("text", x=-3, y=0.8, label= "Median = -0.17
  SD = 0.31
  Good = 0%
  Poor = 100%",
           col="black", size=3) +
  annotate("text", x=3, y=-0.5, label= "Median = 0.48
  SD = 0.54",
           col="black", size=3)
...
#########
# seasonal temp
lowjunocttdiv <- quantile(lower$JunOctT, probs = 0.3) # division
...
bb <- ggplot(data=lower, aes(x=JunOctT,y=RecDev)) +
  ...
  Poor = 86%",
           col="black", size=3) +
  annotate("text", x=0.75, y=-0.5, label= "Median = 0.46
  SD = 0.47",
           col="black", size=3)
...
##########################################################
### lower seasonal sal
lowjunoctsdiv <- quantile(lower$JunOctS, probs = 0.3)
