...
setwd(here("Plots","PRP plots/25th percentile"))
library(ggplot2)

##################### Upper first
### first upper annual temp
uppantdiv <- quantile(upper$AnnT, probs = 0.25) # division
...
aa <- ggplot(data=upper, aes(x=AnnT,y=RecDev)) +
  ...
  theme_bw() +
  annotate("text", x=-0.1, y=0.8, label= "Median = 0.03
  SD = 0.69
  Good = 33%
  Poor = 66%",
           col="black", size=3) +
  annotate("text", x=1, y=-0.5, label= "Median = 0.30
  SD = 0.44",
           col="black", size=3)
aa
...
uppansdiv <- quantile(upper$AnnS, probs = 0.25)
...
ca <- ggplot(data=upper, aes(x=AnnS,y=RecDev)) +
  ...
  theme_bw() +
  annotate("text", x=-2, y=0.8, label= "Median = 0.05
  SD = 0.27
  Good = 0%
  Poor = 100%",
           col="black", size=3) +
  annotate("text", x=2, y=-0.5, label= "Median = 0.47
  SD = 0.55",
           col="black", size=3)
ca
...
#########
# seasonal temp
uppjunocttdiv <- quantile(upper$JunOctT, probs = 0.25) # division
...
ba <- ggplot(data=upper, aes(x=JunOctT,y=RecDev)) +
  ...
  theme_bw() +
  annotate("text", x=-0.8, y=0.8, label= "Median = 0.03
  SD = 0.45
  Good = 0%
  Poor = 100%",
           col="black", size=3) +
...
##########################################################
### seasonal sal
uppjunoctsdiv <- quantile(upper$JunOctS, probs = 0.25)
...
### first upper annual temp
lowantdiv <- quantile(lower$AnnT, probs = 0.25) # division
...
ab <- ggplot(data=lower, aes(x=AnnT,y=RecDev)) +
  ...
  theme_bw() +
  annotate("text", x=0.1, y=0.8, label= "Median = 0.13
  SD = 0.70
  Good = 50%
  Poor = 50%",
           col="black", size=3) +
  annotate("text", x=1, y=-0.5, label= "Median = 0.28
  SD = 0.44",
           col="black", size=3)
...
lowansdiv <- quantile(lower$AnnS, probs = 0.25)
...
cb <- ggplot(data=lower, aes(x=AnnS,y=RecDev)) +
  ...
  theme_bw() +
  annotate("text", x=-3, y=0.8, label= "Median = 0.03
  SD = 0.32
  Good = 17%
  Poor = 83%",
           col="black", size=3) +
  annotate("text", x=3, y=-0.5, label= "Median = 0.40
  SD = 0.54",
           col="black", size=3)
...
#########
# seasonal temp
lowjunocttdiv <- quantile(lower$JunOctT, probs = 0.25) # division
...
bb <- ggplot(data=lower, aes(x=JunOctT,y=RecDev)) +
  ...
  theme_bw() +
  annotate("text", x=-0.5, y=0.8, label= "Median = -0.18
  SD = 0.47
  Good = 17%
  Poor = 83%",
           col="black", size=3) +
  annotate("text", x=0.75, y=-0.5, label= "Median = 0.39
  SD = 0.46",
           col="black", size=3)
...
##########################################################
### lower seasonal sal
lowjunoctsdiv <- quantile(lower$JunOctS, probs = 0.25)
...
db <- ggplot(data=lower, aes(x=JunOctS,y=RecDev)) +
  ...
  theme_bw() +
  annotate("text", x=-4, y=0.8, label= "Median = -0.08
  SD = 0.23
  Good = 0%
  Poor = 100%",
           col="black", size=3) +
