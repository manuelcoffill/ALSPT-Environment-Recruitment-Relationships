...
setwd(here("Plots","PRP plots/33rd percentile"))
library(ggplot2)

##################### Upper first
### first upper annual temp
uppantdiv <- quantile(upper$AnnT, probs = 0.33) # division
...
aa <- ggplot(data=upper, aes(x=AnnT,y=RecDev)) +
  ...
  labs(title="MTD annual bottom temperature", x="Anomaly", y="Log recruitment deviation") +
  theme_bw() +
  annotate("text", x=-0.5, y=0.8, label= "Median = 0.25
  SD = 0.59
  Good = 25%
  Poor = 75%",
           col="black", size=3) +
  annotate("text", x=1, y=-0.5, label= "Median = 0.38
  SD = 0.47",
           col="black", size=3)
aa

#ggsave("PRP_MTDAT.png", width = 10, height = 8, dpi = 1000)
...
uppansdiv <- quantile(upper$AnnS, probs = 0.33)
...
ca <- ggplot(data=upper, aes(x=AnnS,y=RecDev)) +
  ...
  geom_line(data = data.frame(x = c(uppansdiv, Inf), y = c(uppansnotextrec,uppansnotextrec)), aes(x = x , y = y,),
            col="steelblue", size=1) +
  labs(title="MTD annual bottom salinity", x="Anomaly", y="Log recruitment deviation") +
  theme_bw() +
  annotate("text", x=-2, y=0.8, label= "Median = -0.08
  SD = 0.26
  Good = 0%
  Poor = 100%",
           col="black", size=3) +
...
#ggsave("PRP_MTDAS.png", width = 10, height = 8, dpi = 1000)



#########
# seasonal temp
uppjunocttdiv <- quantile(upper$JunOctT, probs = 0.33) # division
...
ba <- ggplot(data=upper, aes(x=JunOctT,y=RecDev)) +
  ...
  geom_line(data = data.frame(x = c(uppjunocttdiv, Inf), y = c(uppjunocttnotextrec,uppjunocttnotextrec)), aes(x = x , y = y,),
            col="steelblue", size=1) +
  labs(title="MTD Jun-Oct bottom temperature", x="Anomaly", y="Log recruitment deviation") +
  theme_bw() +
  annotate("text", x=-0.8, y=0.8, label= "Median = 0.11
  SD = 0.43
  Good = 0%
  Poor = 100%",
           col="black", size=3) +
  annotate("text", x=1, y=-0.5, label= "Median = 0.55
  SD = 0.50",
           col="black", size=3)

ba

#ggsave("PRP_MTDJunOctT.png", width = 10, height = 8, dpi = 1000)
...
##########################################################
### seasonal sal
uppjunoctsdiv <- quantile(upper$JunOctS, probs = 0.33)
...
da <- ggplot(data=upper, aes(x=JunOctS,y=RecDev)) +
  ...
  geom_line(data = data.frame(x = c(uppjunoctsdiv, Inf), y = c(uppjunoctsnotextrec,uppjunoctsnotextrec)), aes(x = x , y = y,),
            col="steelblue", size=1) +
  labs(title="MTD Jun-Oct bottom salinity", x="Anomaly", y="Log recruitment deviation") +
  theme_bw() +
...
#ggsave("PRP_MTDJunOctS.png", width = 10, height = 8, dpi = 1000)
...
### first upper annual temp
lowantdiv <- quantile(lower$AnnT, probs = 0.33) # division
...
ab <- ggplot(data=lower, aes(x=AnnT,y=RecDev)) +
  ...
  geom_line(data = data.frame(x = c(lowantdiv, Inf), y = c(lowantnotextrec,lowantnotextrec)), aes(x = x , y = y,),
            col="steelblue", size=1) +
  labs(title="MB annual bottom temperature", x="Anomaly", y="Log recruitment deviation") +
  theme_bw() +
  ...
  Poor = 62%",
           col="black", size=3) +
  annotate("text", x=1, y=-0.5, label= "Median = 0.47
  SD = 0.30",
           col="black", size=3)

ab

#ggsave("PRP_MBAT.png", width = 10, height = 8, dpi = 1000)
...
lowansdiv <- quantile(lower$AnnS, probs = 0.33)
...
cb <- ggplot(data=lower, aes(x=AnnS,y=RecDev)) +
  ...
  geom_line(data = data.frame(x = c(lowansdiv, Inf), y = c(lowansnotextrec,lowansnotextrec)), aes(x = x , y = y,),
            col="steelblue", size=1) +
  labs(title="MB annual bottom salinity", x="Anomaly", y="Log recruitment deviation") +
  theme_bw() +
  annotate("text", x=-3, y=0.8, label= "Median = -0.08
  SD = 0.28
  Good = 0%
  Poor = 100%",
           col="black", size=3) +
  annotate("text", x=3, y=-0.5, label= "Median = 0.55
  SD = 0.56",
           col="black", size=3)

cb

#ggsave("PRP_MBAS.png", width = 10, height = 8, dpi = 1000)



#########
# seasonal temp
lowjunocttdiv <- quantile(lower$JunOctT, probs = 0.33) # division
...
bb <- ggplot(data=lower, aes(x=JunOctT,y=RecDev)) +
  ...
  geom_line(data = data.frame(x = c(lowjunocttdiv, Inf), y = c(lowjunocttnotextrec,lowjunocttnotextrec)), aes(x = x , y = y,),
            col="steelblue", size=1) +
  labs(title="MB Jun-Oct bottom temperature", x="Anomaly", y="Log recruitment deviation") +
  theme_bw() +
  annotate("text", x=-0.5, y=0.8, label= "Median = -0.15
  SD = 0.40
  Good = 0%
  Poor = 100%",
           col="black", size=3) +
  annotate("text", x=0.75, y=-0.5, label= "Median = 0.55
  SD = 0.45",
           col="black", size=3)

bb

#ggsave("PRP_MBJunOctT.png", width = 10, height = 8, dpi = 1000)
...
##########################################################
### lower seasonal sal
lowjunoctsdiv <- quantile(lower$JunOctS, probs = 0.33)
...
db <- ggplot(data=lower, aes(x=JunOctS,y=RecDev)) +
  ...
  geom_line(data = data.frame(x = c(lowjunoctsdiv, Inf), y = c(lowjunoctsnotextrec,lowjunoctsnotextrec)), aes(x = x , y = y,),
            col="steelblue", size=1) +
  labs(title="MB Jun-Oct bottom salinity", x="Anomaly", y="Log recruitment deviation") +
  theme_bw() +
  annotate("text", x=-3, y=0.8, label= "Median = 0.11
  SD = 0.26
  Good = 0%
...
#ggsave("PRP_MBJunOctS.png", width = 10, height = 8, dpi = 1000)
